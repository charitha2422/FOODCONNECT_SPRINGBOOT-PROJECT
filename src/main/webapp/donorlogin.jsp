        ...
        <div class="form-container">
            ...
            <div class="form-inner">
                ...
                <form action="donorreg" method="post" class="signup">
                    ...
                    <div class="field">
                        <input type="email" id="email" name="demail" placeholder="Email Address"   pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" 
        title="Please enter a valid email address." required>
                    </div>
                    <div class="field">
                        <input type="tel" id="phone-number" name="dcontact" placeholder="Contact"  pattern="[6789][0-9]{9}"  required>
                    </div>
                    <div class="field">
                        <input type="text" id="pickup-location" name="daddress" placeholder="Address" required>
                    </div>
                    <div class="field">
                        <input type="password" id="password" name="dpswd" placeholder="Password"  pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&#])[A-Za-z\d@$!%*?&#]{8,}"  required>
                    </div>
                    <div class="field btn">
                        <div class="btn-layer"></div>
